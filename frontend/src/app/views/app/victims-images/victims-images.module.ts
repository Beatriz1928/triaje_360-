...
import { VictimsImagesRoutingModule } from './victims-images.routing';
import { VictimsImagesComponent } from './victims-images.component';
...
@NgModule({
  declarations: [DataListComponent,  VictimsImagesComponent],
...
export class VictimsImagesModule { }
