...
import { ScenesRoutingModule } from './scenes.routing';
...
@NgModule({
  declarations: [DataListComponent,  ScenesComponent],
 // declarations: [DataListComponent, DetailsComponent, ImageListComponent, ThumbListComponent, ScenesComponent, DetailsAltComponent, AddExerciseComponent],
  imports: [
    SharedModule,
    ScenesRoutingModule,
